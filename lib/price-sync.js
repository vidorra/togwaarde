...
export async function syncPricesForWebsite(website) {
  ...
  for (let i = 0; i < active.length; i++) {
    ...
    // Amazon overslaan: server-side prijs-scraping wordt door Amazon agressief
    // geblokkeerd (403/CAPTCHA vanaf datacenter-IP) en levert vaak geen of een
    // foute prijs. Amazon-prijzen zetten we handmatig; de sync laat ze ongemoeid.
