...
import { ThermometerSun, Thermometer, Info, CheckCircle, ArrowRight, Calculator } from 'lucide-react'

export const metadata = {
  title: 'Wat is TOG Waarde? Complete Uitleg voor Babyslaapzakken | TOGWaarde.nl',
      ...
      <article className="container mx-auto px-4 py-12">
        ...
        <div className="p-6 lg:p-12 bg-white rounded-2xl mb-6">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">TOG Betekenis</h2>
            ...
            <div className="relative bg-primary/5 p-6 rounded-lg mb-6 overflow-hidden before:content-[''] before:absolute before:left-0 before:top-0 before:bottom-0 before:w-1 before:bg-primary">
          ...
          {/* TOG Scale */}
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">De TOG Schaal Uitgelegd</h2>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              {/* TOG 0.5 */}
              <div className="bg-default rounded-2xl p-6 border border-gray-100">
              ...
              <div className="bg-default rounded-2xl p-6 border border-gray-100">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-12 h-12 bg-accent/20 rounded-xl flex items-center justify-center">
                    <span className="text-accent font-bold text-lg">3.5</span>
                  </div>
                  <div>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Waarom is TOG Belangrijk?</h2>
          ...
          {/* How to Choose */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Hoe Kies je de Juiste TOG?</h2>
            <p className="text-lg text-gray-700 mb-6">
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-xl p-6">
              <p className="text-amber-900">
                <ThermometerSun className="w-5 h-5 inline mr-2" />
                <strong>Tip:</strong> Gebruik onze TOG Calculator op de homepage om automatisch de perfecte TOG waarde te berekenen op basis van jouw specifieke situatie.
              </p>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4">
              <div className="bg-primary/10 border-l-4 border-red-500 p-4 rounded-r-lg">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Snelle Referentietabel</h2>
        ...
        <div className="mt-16">
          <div className="bg-gradient-to-r from-primary to-accent rounded-2xl p-8 text-white text-center">
            <ThermometerSun className="w-12 h-12 mx-auto mb-4 opacity-90" />
            <h2 className="text-xl md:text-2xl lg:text-3xl font-bold mb-4 text-white">
              Bereken de Perfecte TOG voor Jouw Baby
            </h2>
            <p className="text-lg mb-6 opacity-90 max-w-2xl mx-auto">
              Gebruik onze gratis TOG Calculator op de homepage om direct te zien welke TOG waarde het beste past bij jouw situatie
            </p>
            <Link
              href="/"
              className="inline-flex items-center gap-2 sm:gap-3 bg-white text-primary font-medium px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base rounded-full hover:bg-gray-100 transition-colors"
            >
        ...
        <div className="mt-12 pt-12 border-t border-gray-200">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Link href="/kennisbank/veilige-slaaptemperatuur" className="group bg-white border border-gray-200 rounded-xl p-6 hover:border-primary transition-colors">
            ...
            <Link href="/producten" className="group bg-white border border-gray-200 rounded-xl p-6 hover:border-primary transition-colors">
              <h3 className="text-xl font-semibold text-gray-900 mb-2 group-hover:text-primary">
                Aanbevolen Slaapzakken
              </h3>
              <p className="text-gray-600 mb-4">
                Ontdek de beste babyslaapzakken per TOG waarde
              </p>
              <span className="inline-flex items-center text-primary font-medium">
