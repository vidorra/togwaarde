...
export default function UltimateTOGCalculator() {
  ...
  const getClothingRecommendations = () => {
    if (kamerTemp < 16) {
      return ['Lange mouw romper', 'Warm slaappakje', '3.5 TOG slaapzak', 'Let op: kamer is kouder dan aanbevolen']
    } else if (kamerTemp < 18) {
      return ['Lange mouw romper', 'Katoenen slaappakje', '2.5-3.5 TOG slaapzak']
    } else if (kamerTemp < 20) {
      return ['Lange mouw romper of slaappakje', '2.5 TOG slaapzak (NHS/Lullaby Trust aanbeveling)']
    } else if (kamerTemp < 22) {
      return ['Korte of lange mouw romper', '1.0-2.5 TOG slaapzak afhankelijk van seizoen']
    } else if (kamerTemp < 24) {
      return ['Korte mouw romper', '0.5-1.0 TOG slaapzak']
    } else {
      return ['Alleen romper of luier', '0.2-0.5 TOG slaapzak of alleen lakentje']
    }
  }
    ...
    <div className="max-w-6xl mx-auto px-4 py-6 bg-white rounded-2xl">
              ...
              <div className="mt-6 rounded-xl bg-background h-64 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-[11px] text-gray-400 mt-1">
                    {gekozenKleding.length} kledingla{gekozenKleding.length === 1 ? 'ag' : 'gen'} + {slaapzakTOG} TOG slaapzak
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="mt-8 p-6 rounded-2xl text-center bg-gray-50">
        <p className="text-sm text-text-secondary mb-2">
          ...
          De TOG-waarden voor individuele kledingstukken zijn schattingen, niet industrie-standaarden.
        </p>
