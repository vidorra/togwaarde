    ...
    <Layout>
      ...
      <section className="pb-0">
        <div className="container mx-auto px-4 relative">
          ...
          <div className="max-w-4xl mx-auto text-center mb-4 relative z-10 pt-16 lg:pt-20 mt-4">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-primary/10 rounded-full mb-4">
              <ThermometerSun className="w-8 h-8 text-primary" />
            </div>

            <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-900 mb-4 font-display mx-6 my-2">
      ...
      {/* Images with badges and buttons in between */}
      <div className="container mx-auto px-4 -mt-12">
        <div className="flex items-end justify-center gap-0">
          ...
          {/* Center content: Description + Trust Badges + Buttons */}
          <div className="flex-1 max-w-7xl flex flex-col items-center justify-start px-4 pb-24 lg:pb-32 self-start pt-12 mb-4">
            {/* Description */}
      ...
      {/* Calculator Section - no top padding */}
      <section id="tog-calculator" className="pb-8 lg:pb-12">
        <div className="container mx-auto px-4">
          <TOGCalculator titleTag="h1" />
        </div>
      </section>
